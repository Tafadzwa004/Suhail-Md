...
global.email ="taffycaptain@gmail.com"
...
global.timezone= process.env.TZ || process.env.TIME_ZONE || "GMT/Central Africa Time";
global.github=process.env.GITHUB|| "https://github.com/SuhailTechInfo/Suhail-Md";
global.gurl  =process.env.GURL  || "https://whatsapp.com/channel/0029Vaax19iI1rclRN1LrX2g";
global.website=process.env.GURL || "https://whatsapp.com/channel/0029Vaax19iI1rclRN1LrX2g" ; 
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://github.com/SuhailTechInfo/Suhail-Md/blob/main/lib/assets/suhail.jpg?raw=true" ; // SET LOGO FOR IMAGE 
global.caption = process.env.CAPTION || global.caption || "The Mentor 601" 


global.devs = "923184474176" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "null";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "263719461327";
...
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "263719461327,263xxxxxxxx";
...
module.exports = {
  ...
  caption : global.caption || "Taffy Captain 601" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴜʜᴀɪʟ²²¹-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
 
  author : process.env.PACK_AUTHER|| "",
  packname: process.env.PACK_NAME || "",
  botname : process.env.BOT_NAME  || "Taffy The Mentor",
  ownername:process.env.OWNER_NAME|| "The Anonymous Legion One 🗽",
  ...
  WORKTYPE: process.env.WORKTYPE || process.env.MODE|| "piblic",
